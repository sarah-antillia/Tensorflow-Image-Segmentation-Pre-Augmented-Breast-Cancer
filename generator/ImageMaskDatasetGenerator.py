...
#
# 2025/01/04 ImageMaskDatasetGenerator.py
...
class ImageMaskDatasetGenerator:
  ...
  def generate(self):
    """
    #image_files_pattern = "./Dataset_BUSI_with_GT/malignant/*).png"
    #mask_files_pattern  = "./Dataset_BUSI_with_GT/malignant/*)_mask.png"
    """
    image_files = glob.glob(self.masks_dir + "/*).png")
    mask_files  = glob.glob(self.images_dir + "/*)_mask.png")
...
if __name__ == "__main__":
  try:
    images_dir  = "./Dataset_BUSI_with_GT/malignant/"
    masks_dir   = "./Dataset_BUSI_with_GT/malignant/"
 
    output_dir  = "./BUSI-master"
    augmentation= True
